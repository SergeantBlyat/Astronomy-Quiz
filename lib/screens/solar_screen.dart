...
import 'package:quizproject/data/solar_question.dart';
...
class SolarScreen extends StatefulWidget {
  ...
  @override
  _SolarScreenState createState() {
    return _SolarScreenState();
  }
}
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
            gradient: LinearGradient(
                colors: [
              Color.fromARGB(255, 255, 156, 117),
              Color.fromARGB(255, 192, 55, 100),
              Color.fromARGB(255, 66, 20, 38),
            ],
