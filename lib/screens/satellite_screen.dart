...
import 'package:quizproject/data/satellite_question.dart';
...
class SatelliteScreen extends StatefulWidget {
  ...
  @override
  _SatelliteScreenState createState() {
    return _SatelliteScreenState();
  }
}
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
            gradient: LinearGradient(
                colors: [
              Color.fromARGB(255, 13, 9, 59),
              Color.fromARGB(255, 80, 150, 216),
            ],
