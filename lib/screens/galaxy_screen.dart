...
import 'package:quizproject/data/galaxy_question.dart';
...
class GalaxyScreen extends StatefulWidget {
  ...
  @override
  _GalaxyScreenState createState() {
    return _GalaxyScreenState();
  }
}
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
            gradient: LinearGradient(
                colors: [
              Color.fromARGB(255, 255, 142, 185),
              Color.fromARGB(255, 88, 28, 116),
              Color.fromARGB(255, 21, 8, 51),
            ],
