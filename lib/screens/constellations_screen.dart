...
import 'package:quizproject/data/constellations_question.dart';
...
class ConstellationsScreen extends StatefulWidget {
  ...
  @override
  _ConstellationsScreenState createState() {
    return _ConstellationsScreenState();
  }
}
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
            gradient: LinearGradient(
                colors: [
              Color.fromARGB(255, 86, 126, 236),
              Color.fromARGB(255, 238, 123, 123),
            ],
